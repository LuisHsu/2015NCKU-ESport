function uther_mouseover(){
	document.getElementById("uther_button").src="Resources/uther_hover_index.png";
}
function uther_mouseout(){
	document.getElementById("uther_button").src="Resources/uther_button_index.png";
}
/*
...
function ezreal_mouseover(){
	document.getElementById("ezreal_button").src="Resources/ezreal_apply_hover.png";
}
...
function hearthstone_mouseover(){
	document.getElementById("hearthstone_button").src="Resources/hearthstone_apply_hover.png";
}
...
function sona_mouseover(){
	document.getElementById("sona_button").src="Resources/sona_apply_hover.png";
}
